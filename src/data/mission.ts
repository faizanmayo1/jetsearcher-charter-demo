...
export const OPTIONS: Option[] = [
  {
    ...
    tradeoff:
      'The most expensive of the two viable options by £2,619. It buys 1h 26m less time in the air for a ventilated cardiac patient, which is a clinical decision rather than a commercial one.',
    fit: [
      ...
      { requirement: 'No technical stop', met: true, detail: 'Direct, 1,566 nm inside range' },
    ],
    lines: withFee([
      { label: 'Aircraft charter, 6h 00m block', group: 'Aircraft', amount: 24900, note: '£4,150 per block hour' },
      { label: 'Fuel surcharge', group: 'Aircraft', amount: 2210 },
      { label: 'Crew duty extension provision', group: 'Aircraft', amount: 520 },
      { label: 'Medical crew, physician and flight nurse', group: 'Medical', amount: 3600 },
      { label: 'ICU equipment and consumables', group: 'Medical', amount: 1450, note: 'Ventilator, pumps, oxygen, defibrillator' },
      { label: 'Landing and handling, Antalya', group: 'Airport and handling', amount: 980 },
      { label: 'Landing and handling, Biggin Hill', group: 'Airport and handling', amount: 1140 },
      { label: 'Overflight and navigation, five regions', group: 'Airspace and permits', amount: 1780 },
      { label: 'Türkiye ambulance flight permit', group: 'Airspace and permits', amount: 420, note: 'Medical clearance filed with the permit' },
      { label: 'Ground ambulance, hospital to Antalya', group: 'Ground transfer', amount: 680 },
      { label: 'Ground ambulance, Biggin Hill to London', group: 'Ground transfer', amount: 890 },
    ]),
  },
  {
    id: 'OPT-B',
    ...
    tradeoff:
      'Saves £2,619 and adds 1h 26m to patient transit, including a fuel stop at Rome Ciampino with the patient on board. Dual accredited and closer to the pickup, so positioning is quick.',
    fit: [
      ...
      { requirement: 'Oxygen, 4,200 litres', met: true, detail: '4,400 litres available, no margin for a diversion' },
      ...
      { requirement: 'No technical stop', met: false, detail: 'Fuel stop at Rome Ciampino, 55 minutes on the ground' },
    ],
    lines: withFee([
      { label: 'Aircraft charter, 7h 30m block', group: 'Aircraft', amount: 21375, note: '£2,850 per block hour' },
      { label: 'Fuel surcharge', group: 'Aircraft', amount: 1780 },
      { label: 'Crew duty extension provision', group: 'Aircraft', amount: 640, note: 'Longer duty day because of the technical stop' },
      { label: 'Medical crew, physician and flight nurse', group: 'Medical', amount: 3400 },
      { label: 'ICU equipment and consumables', group: 'Medical', amount: 1380 },
      { label: 'Landing and handling, Antalya', group: 'Airport and handling', amount: 980 },
      { label: 'Technical stop, Rome Ciampino', group: 'Airport and handling', amount: 1640, note: 'Landing, handling and fuel uplift' },
      { label: 'Landing and handling, Biggin Hill', group: 'Airport and handling', amount: 1140 },
      { label: 'Overflight and navigation, six regions', group: 'Airspace and permits', amount: 1820 },
      { label: 'Türkiye ambulance flight permit', group: 'Airspace and permits', amount: 420 },
      { label: 'Ground ambulance, hospital to Antalya', group: 'Ground transfer', amount: 680 },
      { label: 'Ground ambulance, Biggin Hill to London', group: 'Ground transfer', amount: 890 },
    ]),
  },
  {
    ...
    lines: withFee([
      { label: 'Aircraft charter, 7h 00m block', group: 'Aircraft', amount: 36400, note: '£5,200 per block hour' },
      { label: 'Fuel surcharge', group: 'Aircraft', amount: 3120 },
      { label: 'Crew duty extension provision', group: 'Aircraft', amount: 780 },
      { label: 'Third party medical escort team', group: 'Medical', amount: 4100, note: 'Sub-contracted, not the operator' },
      { label: 'Portable ICU kit hire', group: 'Medical', amount: 2250 },
      { label: 'Landing and handling, Antalya', group: 'Airport and handling', amount: 1180 },
      { label: 'Landing and handling, Biggin Hill', group: 'Airport and handling', amount: 1420 },
      { label: 'Overflight and navigation, five regions', group: 'Airspace and permits', amount: 1980 },
      { label: 'Türkiye ambulance flight permit', group: 'Airspace and permits', amount: 420 },
      { label: 'Ground ambulance, hospital to Antalya', group: 'Ground transfer', amount: 680 },
      { label: 'Ground ambulance, Biggin Hill to London', group: 'Ground transfer', amount: 890 },
    ]),
